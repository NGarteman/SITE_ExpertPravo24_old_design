          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <div class="video-container">
                  ...
                  <source src="img/2.webm" type="video/mp4" >    
                  </video>
                ...
                <div class="videotext center">
                  ...
                  <img class="baton" src="img/visa.png" width="40%" height="70%"></br>            
  ...
  <h5>КОТОРЫЕ МЫ ИЗУЧИЛИ ОТ И ДО</h5>
    ...
    <div class="container">
      <div class="row" style=" text-align: center;">
        <span class="col-sm dot"><img src="img/1.png" alt="" width="40%" style="padding: 17px;">
     ...
     оказаны / работы не выполнены"</p>
        ...
        <span class="col-sm dot"><img src="img/2.png" alt="" width="40%" style="padding: 15px;">
        ...
        <span class="col-sm dot"><img src="img/3.png" alt="" width="27%" style="padding-top: -30px;">
    ...
    <div class="block_novozvrat">
      <div class="container">
        <h1 class="block4_h1" style="font-size: 30px;">Участники процедуры возврата средств</h1></br><hr style="border-color:green;border-style:solid" >
         <div class="container"><img src="img/cicle.png" alt="" 
